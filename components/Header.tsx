        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 0 10px", borderBottom: "1px solid #e8ecf0" }}>
          <Link href="/" style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div style={{ display: "flex", alignItems: "baseline", gap: 1 }}>
              ...
              <span style={{ fontSize: 12, fontWeight: 800, color: "#1a6fa8", marginLeft: 1 }}>com</span>
            </div>
          </Link>
          ...
          <Link href="/ilan-ver" style={{ background: "#1a6fa8", color: "#fff", borderRadius: 20, padding: "8px 18px", fontSize: 13, fontWeight: 800 }}>+ İlan Ver</Link>
        </div>
        <nav style={{ display: "flex" }}>
          {NAV.map(n => (
            <Link key={n.href} href={n.href} style={{ color: "#6b7a8d", fontSize: 13, fontWeight: 600, padding: "10px 14px", display: "block" }}>{n.label}</Link>
          ))}
        </nav>
      </div>
    </header>
